...
const Templates = (function() {
    ...
    // Use the namespaced loader if present (Foundry >= 13+), otherwise fall back to global loadTemplates
    const templateLoader = (typeof foundry !== "undefined" && foundry.applications?.handlebars?.loadTemplates)
        ? foundry.applications.handlebars.loadTemplates.bind(foundry.applications.handlebars)
        : (globalThis.loadTemplates ?? (async (t) => { console.warn("No template loader found"); return Promise.resolve(); }));
